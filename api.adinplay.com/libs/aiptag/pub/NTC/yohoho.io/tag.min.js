...
g=function(){var a=("; "+b.cookie).split("; euconsent=");a=2===a.length?a.pop().split(";").shift():void 0;return"undefined"===typeof a?!1:!0},e=function(c,d,g,e,q){"undefined"===typeof q&&(q="/");"undefined"===typeof e?(e=(a&&a.location&&a.location.hostname||"").split("."),e=";domain="+(1<e.length?e.slice(-2).join("."):"")):e="";var n=new Date;n.setSeconds(n.getSeconds()+g);b.cookie=c+" = "+d+e+";path="+q+";max-age="+g+";Expires="+n.toUTCString()},h=function(){aiptag.gdprVendors={id:aipAPItag.gdpr.googleId,
...
aipAPI.prototype.log=function(a,b){if(this.debug){if("string"==typeof a){var c=(new Date).toLocaleTimeString();c+=":"+(new Date).getMilliseconds();window.console.log.apply(console,["%cAdinPlay","display: inline-block; color: #fff; background: #DD0420; padding: 1px 4px; border-radius: 3px;",c,a])}else console.log(a);b&&console.log(b)}};
...
aipAPI.prototype.wait=function(a,b,c,d,g){var e=0,h=function(){e+=a;c()?d():e>=b?g():setTimeout(h,a)};h()};aipAPI.prototype.inIframe=function(){try{return window.self!==window.top}catch(a){return!0}};aipAPI.prototype.sendEvent=function(a){this.log(a);aipSendEvent(a)};var aipSendEvent=function(a){};
aipAPI.prototype.setCurrency=function(){pbjs.que.push(function(){pbjs.setConfig({currency:{adServerCurrency:"EUR",granularityMultiplier:1,conversionRateFile:"//api.adinplay.com/libs/currency/latest.json",bidderCurrencyDefault:{openx:"EUR"}}})})};
aipAPI.prototype.getAllWinningBids=function(){(function(){var a=pbjs.getBidResponses(),b=pbjs.getAllWinningBids(),c=[];Object.keys(a).forEach(function(d){a[d].bids.forEach(function(a){c.push({bid:a,adunit:d,adId:a.adId,bidder:a.bidder,time:a.timeToRespond,cpm:a.cpm,msg:a.statusMessage,rendered:!!b.find(function(b){return b.adId==a.adId})})})});if(c.length)if(console.table)console.table(c);else for(var d=0;d<c.length;d++)console.log(c[d]);else console.warn("NO prebid responses")})()};
aipAPI.prototype.getHighestCpmBids=function(){for(var a=pbjs.getHighestCpmBids(),b=[],c=0;c<a.length;c++){var d=a[c];b.push({adunit:d.adUnitCode,adId:d.adId,bidder:d.bidder,time:d.timeToRespond,cpm:d.cpm})}if(b.length)if(console.table)console.table(b);else for(a=0;a<b.length;a++)console.log(b[a]);else console.warn("No prebid winners")};
aipAPI.prototype.start=function(){try{clearTimeout(aipAPItag.GDPRloadTimeout)}catch(b){}if(!0!==aipAPItag.started){aipAPItag.started=!0;aipDisplayTag=new aipDisplay;aipDisplayTag.displayInit();aipAPItag.initDisplayTag();aipAPItag.sdkLoaded()?aipAPItag.initPlayerTag():aipAPItag.getScript("//imasdk.googleapis.com/js/sdkloader/ima3.js",function(){aipAPItag.initPlayerTag();aipAPItag.sdkLoaded()||(aipAPItag.sdkBlocked=!0)});try{if("function"===typeof aipGDPRCallback_OnAccept){var a=!0;!1===aipAPItag.getConsent()&&
(a=!1);aipGDPRCallback_OnAccept(a)}}catch(b){}}};
...
function aipDisplay(){googletag.cmd.push(function(){googletag.pubads().disableInitialLoad()});aipAPItag.gptLoaded||(function(){var a=document.createElement("script");a.async=!0;a.type="text/javascript";a.src=aipAPItag.protocol+"www.googletagservices.com/tag/js/gpt.js";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}(),aipAPItag.gptLoaded=!0);aipAPItag.debug&&googletag.cmd.push(function(){googletag.pubads().addEventListener("slotVisibilityChanged",function(a){aipAPItag.log("slotVisibilityChanged: "+
a.slot.getSlotElementId()+" - "+a.inViewPercentage+"% visible");aipAPItag.log(a)});googletag.pubads().addEventListener("slotOnload",function(a){aipAPItag.log("slotOnload: "+a.slot.getSlotElementId());aipAPItag.log(a)});googletag.pubads().addEventListener("slotRenderEnded",function(a){aipAPItag.log("slotRenderEnded: "+a.slot.getSlotElementId());aipAPItag.log(a)});googletag.pubads().addEventListener("impressionViewable",function(a){aipAPItag.log("impressionViewable: "+a.slot.getSlotElementId());aipAPItag.log(a)})})}
aipDisplay.prototype.displayInit=function(){};
aipDisplay.prototype.displaySetup=function(a){pbjs.que.push(function(){aipAPItag.displayBidCpm.rhythmone=.9;aipAPItag.displayBidCpm.rubicon=.62;aipAPItag.displayBidCpm.GumGum=.95;pbjs.bidderSettings={rhythmone:{bidCpmAdjustment:function(a,c){aipAPItag.log("Bid adjust for: "+c.bidderCode);return a*aipAPItag.displayBidCpm.rhythmone}},rubicon:{bidCpmAdjustment:function(a,c){aipAPItag.log("Bid adjust for: "+c.bidderCode);return a*aipAPItag.displayBidCpm.rubicon}},gumgum:{bidCpmAdjustment:function(a,c){aipAPItag.log("Bid adjust for: "+
c.bidderCode);return a*aipAPItag.displayBidCpm.GumGum}}};aipAPItag.debug&&pbjs.setConfig({debug:!0});pbjs.setConfig({userSync:{iframeEnabled:!0,useBidCache:!0,syncsPerBidder:99999,filterSettings:{iframe:{bidders:"*",filter:"include"}},syncDelay:6E3},bidderTimeout:aipAPItag.timeout_bid_display,enableSendAllBids:!0,bidderSequence:"random",priceGranularity:{buckets:[{precision:2,min:0,max:.5,increment:.01},{precision:2,min:.5,max:5,increment:.05},{precision:2,min:5,max:10,increment:.1},{precision:2,
min:10,max:20,increment:.5}]},publisherDomain:aipAPItag.protocol+"api.adinplay.com"})})};aipDisplay.prototype.clear=function(a){googletag.cmd.push(function(){googletag.pubads().clear([aipAPItag.adSlot[a]]);aipAPItag.log("AD SLOT CLEARED: "+a)})};aipDisplay.prototype.destroy=function(a){googletag.cmd.push(function(){googletag.destroySlots([aipAPItag.adSlot[a]]);aipAPItag.adUnitsLoaded[a]=null;aipAPItag.log("AD SLOT DESTROYED: "+a)})};
aipDisplay.prototype.setReload=function(a){aipAPItag.adSlots[a].reload=!0};aipDisplay.prototype.unsetReload=function(a){aipAPItag.adSlots[a].reload=!1};aipDisplay.prototype.getReload=function(a){return aipAPItag.adSlots[a].reload};aipDisplay.prototype.display=function(a){aipAPItag.log("AD SLOT DISPLAY: "+a);aipDisplayTag.refresh(a)};aipDisplay.prototype.refresh=function(a){aipAPItag.log("AD SLOT REFRESH: "+a);aiptag.cmd.queue.push(aipDisplayTag.wrapFunction(aipDisplayTag.refreshTag,this,[a]));aipDisplayTag.nextQueue()};
aipDisplay.prototype.refreshTag=function(a){aipAPItag.queue_ready_display=!0;if(aipDisplayTag.getReload(a)){aipAPItag.adUnitsRefreshed[a]||(aipAPItag.adUnitsRefreshed[a]=0);aipAPItag.adUnitsRefreshed[a]++;try{aipAPItag.log("aiptag.gdprConsent: "+aiptag.gdprConsent)}catch(c){}!1===aipAPItag.getConsent()?googletag.cmd.push(function(){aipAPItag.log("Setting DFP to deliver non targeted ads...");googletag.pubads().setRequestNonPersonalizedAds(1)}):googletag.cmd.push(function(){aipAPItag.log("Setting DFP to deliver targeted ads...");
googletag.pubads().setRequestNonPersonalizedAds(0)});aipAPItag.inIframe()?(aipAPItag.log("iframe display AD"),googletag.cmd.push(function(){googletag.pubads().setTargeting("GS","Yes")})):(aipAPItag.log("none iframe display Ad"),googletag.cmd.push(function(){googletag.pubads().setTargeting("GS","No")}));aiptag.subid&&(aipAPItag.log("Custom SubID"),googletag.cmd.push(function(){googletag.pubads().setTargeting("subid",aiptag.subid)}));googletag.cmd.push(function(){try{var b=aipAPItag.adUnitsRefreshed[a].toString();
googletag.pubads().setTargeting("FC",b);aipAPItag.log(a+", FC="+b)}catch(d){}});var b="Other";try{/(cros)/.test(window.navigator.userAgent.toLowerCase())&&(b="ChromeOS")}catch(c){}googletag.cmd.push(function(){googletag.pubads().setTargeting("OS",b);aipAPItag.log("OS="+b)});aipAPItag.log("AD SLOT REFRESHTAG: "+a+" - "+aipAPItag.adUnitsRefreshed[a]);aipAPItag.queue_ready_display=!1;pbjs.que.push(function(){aipAPItag.adUnitsLoaded[a]||(aipAPItag.adUnitsLoaded[a]="loaded",googletag.cmd.push(function(){aipAPItag.adSlot[a]=
googletag.defineSlot("/421469808/"+aipAPItag.adSlots[a].adunit,aipAPItag.adSlots[a].sizes,a).addService(googletag.pubads());googletag.enableServices();googletag.display(a);aipAPItag.log("AD SLOT DEFINED: "+a)}));aipDisplayTag.unsetReload(a);setTimeout(aipDisplayTag.setReload.bind(null,a),aipAPItag.timeout_reload_display);aipDisplayTag.displaySetup(a);var b=aipAPItag.timeout_bid_display;aipAPItag.log("AD REQUEST: "+a);pbjs.requestBids({timeout:b,adUnits:aipAPItag.adUnits[a],adUnitCodes:[a],bidsBackHandler:function(b){try{aipAPItag.log("Targeting params:"),
aipAPItag.log(JSON.stringify(pbjs.getAdserverTargeting())),aipAPItag.log("All bid objects:"),aipAPItag.log(JSON.stringify(pbjs.getBidResponses()))}catch(g){}googletag.cmd.push(function(){pbjs.setTargetingForGPTAsync([a]);googletag.pubads().refresh([aipAPItag.adSlot[a]]);aipAPItag.log("AD LOAD: "+a);aipAPItag.queue_ready_display=!0;aipDisplayTag.nextQueue()})}})})}else aipAPItag.log("AD REFRESH called to soon for: "+a),aipDisplayTag.nextQueue()};
aipDisplay.prototype.wrapFunction=function(a,b,c){return function(){a.apply(b,c)}};aipDisplay.prototype.nextQueue=function(){1==aipAPItag.queue_ready_display&&0<aiptag.cmd.queue.length&&(aipAPItag.log("AD SLOT NEXT QUEUE"),aiptag.cmd.queue.shift()())};
function aipPlayer(a){this.aipConfig={VERSION:"2.0",AD_WIDTH:960,AD_HEIGHT:540,LOADING_TEXT:"loading advertisement",PREROLL_ELEM:function(){return document.getElementById("preroll")},PREROLL_ELEM_ID:!1,PREROLL_CONTAINER:!1,AD_FULLSCREEN:!1,AD_CENTERPLAYER:!1,AD_FADING:!0,DESCRIPTION_URL:aipAPItag.protocol+"yohoho.io/"};a&&this.configure(a);this.videoAdUnit=[];this.videoAdUnit["yohoho.io_preroll"]={code:"prerollUnit",mediaTypes:{video:{context:"instream",playerSize:[960,540]}},bids:[{bidder:"appnexus",
params:{placementId:"14506715",video:{skippable:!0,playback_method:["auto_play_sound_on"]}}}]};try{var b=document.createElement("style");this.aipConfig.PREROLL_ELEM_ID="function"===typeof this.aipConfig.PREROLL_ELEM?this.aipConfig.PREROLL_ELEM().id:this.aipConfig.PREROLL_ELEM.id;b.type="text/css";b.innerHTML="#"+this.aipConfig.PREROLL_ELEM_ID+" video {left: 0;top: 0;}";document.getElementsByTagName("head")[0].appendChild(b)}catch(c){}}
aipPlayer.prototype.configure=function(a){var b;for(b in a){var c=a[b];void 0!==c&&a.hasOwnProperty(b)&&(this.aipConfig[b]=c)}return this};
aipPlayer.prototype.getBidPrerollTag=function(a){pbjs.que.push(function(){aipAPItag.debug&&pbjs.setConfig({debug:!0});pbjs.setConfig({userSync:{iframeEnabled:!0,useBidCache:!0,syncsPerBidder:99999,filterSettings:{iframe:{bidders:"*",filter:"include"}},syncDelay:6E3},cache:{url:"https://prebid.adnxs.com/pbc/v1/cache"},bidderTimeout:aipAPItag.timeout_bid_player,enableSendAllBids:!1,bidderSequence:"random",priceGranularity:{buckets:[{precision:2,min:0,max:.1,increment:.01},{precision:2,min:.1,max:10,
increment:.05},{precision:2,min:10,max:15,increment:.25},{precision:2,min:15,max:30,increment:.5},{precision:2,min:30,max:40,increment:1},{precision:2,min:40,max:75,increment:5}]},publisherDomain:aipAPItag.protocol+"api.adinplay.com"});pbjs.requestBids({timeout:aipAPItag.timeout_bid_player,adUnits:[a.videoAdUnit[a.aipConfig.AD_UNIT_PREROLL]],adUnitCodes:["prerollUnit"],bidsBackHandler:function(b){b=pbjs.adServers.dfp.buildVideoUrl({adUnit:a.videoAdUnit[a.aipConfig.AD_UNIT_PREROLL],params:{iu:"/421469808/"+
a.aipConfig.AD_UNIT_PREROLL,output:"vast"}});pbjs.markWinningBidAsUsed({adUnitCode:a.videoAdUnit[a.aipConfig.AD_UNIT_PREROLL].code});aipAPItag.log(b);a.aipConfig.AD_TAG=b;a.preparePreRoll()}})})};
aipPlayer.prototype.preparePreRoll=function(){var a={};try{aipAPItag.log("aiptag.gdprConsent: "+aiptag.gdprConsent)}catch(c){}!1===aipAPItag.getConsent()&&(a.npa="1",aipAPItag.log("Preroll consent set to: false"));aipAPItag.inIframe()?(a.GS="Yes",aipAPItag.log("iframe preroll AD")):a.GS="No";aiptag.subid&&(a.subid=aiptag.subid,aipAPItag.log("Custom SubID"));a.FC=aiptag.prerollCount;var b=Object.keys(a).map(function(b){return b+"%3D"+a[b]}).join("%26");if(b)try{this.aipConfig.AD_TAG=aipAPItag.urlParamUpdate(this.aipConfig.AD_TAG,
"cust_params",b,!0)}catch(c){}this.prepareAd()};
aipPlayer.prototype.startPreRoll=function(a){this.aipConfig.AD_UNIT_PREROLL="yohoho.io_preroll";a&&(this.aipConfig.AD_UNIT_PREROLL=a);a=(new Date).getTime();var b=encodeURIComponent(window.location.href).replace(/'/g,"%27").replace(/"/g,"%22"),c=encodeURIComponent(this.aipConfig.DESCRIPTION_URL).replace(/'/g,"%27").replace(/"/g,"%22");this.aipConfig.AD_TAG="https://pubads.g.doubleclick.net/gampad/ads?sz=960x540&iu=/421469808/"+this.aipConfig.AD_UNIT_PREROLL+"&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&max_ad_duration=30000&url="+
b+"&description_url="+c+"&correlator="+a;aipAPItag.log(this.aipConfig.AD_TAG);aiptag.prerollCount=aiptag.prerollCount+1||1;aipAPItag.inIframe()?(aipAPItag.log("iframe AD - Normal Ad"),this.preparePreRoll()):(aipAPItag.log("none iframe - Bid Ad"),this.getBidPrerollTag(this))};
aipPlayer.prototype.prepareAd=function(){if(1==aipAPItag.sdkBlocked)aipAPItag.log("AD BLOCKED"),this.aipComplete(),this.aipConfig.AIP_BLOCKED&&this.aipConfig.AIP_BLOCKED(),aipAPItag.sendEvent("user-has-adblock");else if("function"===typeof this.aipConfig.PREROLL_ELEM&&(this.aipConfig.PREROLL_ELEM=this.aipConfig.PREROLL_ELEM()),aipAPItag.isInPage(this.aipConfig.PREROLL_ELEM)){aipAPItag.isMobile()&&(this.aipConfig.AD_FULLSCREEN=!0);this.activeViewDetect();this.aipConfig.AD_FULLSCREEN&&this.aipConfig.AD_CENTERPLAYER&&
(this.aipConfig.AD_CENTERPLAYER=!1,console.log("***WARNING*** AD_FULLSCREEN and AD_CENTERPLAYER cannot both be set to true, setting AD_CENTERPLAYER to false"));if(this.aipConfig.AD_FULLSCREEN)this.aipConfig.PREROLL_CONTAINER=this.aipConfig.PREROLL_ELEM;else{var a=document.getElementById("aipPrerollContainer");if("undefined"==typeof a||null==a)a=document.createElement("div"),a.id="aipPrerollContainer",this.aipConfig.PREROLL_ELEM.appendChild(a);this.aipConfig.PREROLL_CONTAINER=document.getElementById("aipPrerollContainer");
try{var b=window.getComputedStyle(this.aipConfig.PREROLL_ELEM,null).getPropertyValue("position");if(""==b||"static"==b)this.aipConfig.PREROLL_ELEM.style.position="relative"}catch(d){}try{var c=window.getComputedStyle(this.aipConfig.PREROLL_ELEM,null).getPropertyValue("z-index");if(""==c||isNaN(c))this.aipConfig.PREROLL_ELEM.style.zIndex="999996"}catch(d){}this.aipConfig.AD_CENTERPLAYER&&(this.aipConfig.PREROLL_ELEM.style.top="0",this.aipConfig.PREROLL_ELEM.style.left="0",this.aipConfig.PREROLL_ELEM.style.bottom=
"0",this.aipConfig.PREROLL_ELEM.style.right="0",this.aipConfig.PREROLL_ELEM.style.width=this.aipConfig.AD_WIDTH+"px",this.aipConfig.PREROLL_ELEM.style.height=this.aipConfig.AD_HEIGHT+26+"px",this.aipConfig.PREROLL_ELEM.style.position="fixed",this.aipConfig.PREROLL_ELEM.style.zIndex="999996",this.aipConfig.PREROLL_ELEM.style.margin="auto")}this.showLoading(!0);this.aipConfig.AD_FULLSCREEN?(this.aipConfig.PREROLL_CONTAINER.style.top="0",this.aipConfig.PREROLL_CONTAINER.style.left="0",this.aipConfig.PREROLL_CONTAINER.style.width=
"100%",this.aipConfig.PREROLL_CONTAINER.style.height="100%",this.aipConfig.PREROLL_CONTAINER.style.position="fixed",this.aipConfig.PREROLL_CONTAINER.style.zIndex="999996",this.aipConfig.PREROLL_CONTAINER.style.overflow="hidden",this.aipConfig.PREROLL_CONTAINER.className=""):(this.aipConfig.PREROLL_CONTAINER.style.width=this.aipConfig.AD_WIDTH+"px",this.aipConfig.PREROLL_CONTAINER.style.height=this.aipConfig.AD_HEIGHT+"px");this.aipConfig.PREROLL_CONTAINER.style.backgroundColor="#000000";aipAPItag.sdkLoaded()?
this.startAd():(aipAPItag.log("Ads lib not ready yet"),aipAPItag.wait(100,7500,function(){return 1==aipAPItag.sdkBlocked||1==aipAPItag.sdkLoaded()}.bind(this),function(){aipAPItag.log("Ads lib ready after interval");this.startAd()}.bind(this),function(){aipAPItag.log("Ads lib failed to load after interval");this.aipComplete()}.bind(this)))}else console.log("***WARNING*** PREROLL_ELEM does not exists, AD cant be played"),this.aipComplete()};
aipPlayer.prototype.startAd=function(){1==aipAPItag.sdkBlocked?(aipAPItag.log("AD BLOCKED"),this.aipComplete(),this.aipConfig.AIP_BLOCKED&&this.aipConfig.AIP_BLOCKED(),aipAPItag.sendEvent("user-has-adblock")):(aipAPItag.log("Final vasturl="+this.aipConfig.AD_TAG),this.requestAd(this,this.aipConfig.AD_TAG,aipAPItag.log,!0))};
aipPlayer.prototype.aipComplete=function(){try{this.aipConfig.PREROLL_ELEM.style.display="none"}catch(a){}this.showLoading(!1);this.aipConfig.AIP_COMPLETE&&setTimeout(function(){this.aipConfig.AIP_COMPLETE()}.bind(this),300);this.aipConfig.AIP_REMOVE&&setTimeout(function(){aipAPItag.isInPage(this.aipConfig.PREROLL_CONTAINER)||1!=aipAPItag.sdkBlocked&&console.log("***WARNING*** PREROLL_CONTAINER is removed prematurely, please do not remove PREROLL_CONTAINER on AIP_COMPLETE, you can remove it on AIP_REMOVE");
this.aipConfig.AIP_REMOVE()}.bind(this),3E3);try{document.getElementById(aipThis.aipConfig.PREROLL_ELEM_ID).removeEventListener("click",handlePaused)}catch(a){}};
aipPlayer.prototype.showLoading=function(a){if(this.aipConfig.AD_FULLSCREEN)a?(a=document.createElement("div"),a.id="divFullscreenLoading",a.style.overflow="hidden",a.style.position="fixed",a.style.zIndex="999997",a.style.margin="auto",a.style.top="0",a.style.left="0",a.style.bottom="0",a.style.right="0",a.style.width="100%",a.style.height="100%",a.style.backgroundColor="#000000",a.innerHTML='<img border="0" style="position: fixed;z-index: 999998;top: 50%;left: 50%;transform: translate(-50%, -50%);" src="//api.adinplay.com/libs/aiptag/assets/loader-red.gif" />',
document.getElementsByTagName("body")[0].appendChild(a)):(a=document.getElementById("divFullscreenLoading"),"undefined"!=typeof a&&null!=a&&(a=document.getElementById("divFullscreenLoading"),a.parentNode.removeChild(a)));else if(a){if(a=document.createElement("div"),a.id="divFullscreenLoading",a.style.overflow="hidden",a.style.position="absolute",a.style.margin="0 auto",a.style.top="0",a.style.left="0",a.style.bottom="0",a.style.right="0",a.style.zIndex="999997",a.style.width=this.aipConfig.AD_WIDTH+
"px",a.style.height=this.aipConfig.AD_HEIGHT+"px",a.style.backgroundColor="#000000",a.innerHTML='<img border="0" style="position: absolute;z-index: 999998;top: 50%;left: 50%;transform: translate(-50%, -50%);" src="//api.adinplay.com/libs/aiptag/assets/loader-red.gif" />',this.aipConfig.PREROLL_ELEM.appendChild(a),a=document.getElementById("aipLoadingText"),"undefined"==typeof a||null==a)a=document.createElement("div"),a.id="aipLoadingText",a.innerHTML='<div id="aipLoadingBG" style="line-height: normal;height:auto;position: relative;z-index: 999995;background-color: #000000;border-top: 1px solid #ffffff;text-align: left;width: '+
this.aipConfig.AD_WIDTH+'px;"><span style="font-size: 16px;font-family: \'open sans\';font-weight: 100;color: #fff;padding-left: 5px;" id="loading-text-aip">'+this.aipConfig.LOADING_TEXT+'<img style="margin-left: 10px;vertical-align: middle;" src="data:image/gif;base64,"/></span></div>',
this.aipConfig.PREROLL_ELEM.appendChild(a)}else a=document.getElementById("divFullscreenLoading"),"undefined"!=typeof a&&null!=a&&(a=document.getElementById("divFullscreenLoading"),a.parentNode.removeChild(a)),a=document.getElementById("aipLoadingText"),"undefined"!=typeof a&&null!=a&&(a=document.getElementById("aipLoadingText"),a.parentNode.removeChild(a))};
aipPlayer.prototype.showBranding=function(){if(!this.aipConfig.AD_FULLSCREEN){var a=document.createElement("div");a.id="aipLoadingText";a.innerHTML='<div style="border-top: 1px solid #ffffff;min-height: 25px;background-color: #000000;position: relative;width: '+this.aipConfig.AD_WIDTH+'px;"><span style="font-size: 16px;font-family: \'open sans\';font-weight: 100;color: #fff;padding-left: 5px;" id="loading-text-aip"></span><a style="margin-top: 6px;position: absolute;right: 5px;" target="_blank" href="http://www.adinplay.com/"><img style="vertical-align: top;position: relative;" id="aipLogo" src="data:image/png;base64," border="0" /></a></div></div>';
this.aipConfig.PREROLL_ELEM.appendChild(a)}};aipPlayer.prototype.activeViewDetect=function(){var a=window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight;if((window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth)<this.aipConfig.AD_WIDTH||a<this.aipConfig.AD_HEIGHT)this.aipConfig.AD_FULLSCREEN=!0};
aipPlayer.prototype.requestAd=function(a,b,c,d){null==aipAPItag.aipAds&&(c("LOADED FIRST TIME"),aipAPItag.aipAds=new AipAds(a,a.aipConfig.PREROLL_CONTAINER,a.aipConfig.PREROLL_CONTAINER,d));try{aipAPItag.aipAds.requestAds(b,c),a.aipConfig.PREROLL_ELEM.style.display="block"}catch(g){c("EXCEPTION",{name:g.name,message:g.message,stack:g.stack}),a.aipComplete()}};
function AipAds(a,b,c,d){function g(){aipAPItag.sendEvent("video-ad-paused");try{document.getElementById(a.aipConfig.PREROLL_ELEM_ID).addEventListener("click",e)}catch(y){}}function e(){aipAPItag.sendEvent("video-ad-resumed-forced");f.resume()}function h(){aipAPItag.sendEvent("video-ad-resumed");try{document.getElementById(a.aipConfig.PREROLL_ELEM_ID).removeEventListener("click",e)}catch(y){}}function l(a){m("EXCEPTION",{name:a.name,message:a.message,stack:a.stack})}function B(a){var b="",c="",d=
"";try{b=a.getAd().getContentType(),c=a.getAd().getMinSuggestedDuration(),d=a.getAd().getCreativeId()}catch(D){l(D)}m("CONTENT_PAUSE_REQUESTED",{contentType:b,creativeId:d,minSuggestedDuration:c})}function C(b){n();c.style.display="block";a.showLoading(!1);a.showBranding();a.aipConfig.AIP_STARTED&&a.aipConfig.AIP_STARTED();if(d)try{m("MediaUrl: "+b.getAd().getMediaUrl()+"; AdvertiserName: "+b.getAd().getAdvertiserName()+"; Description: "+b.getAd().getDescription()+"; Title: "+b.getAd().getTitle())}catch(z){l(z)}m("STARTED");
aipAPItag.sendEvent("video-ad-started")}function u(){try{clearTimeout(aipAPItag.completedTimeoutPreroll)}catch(y){}p.contentComplete();f.destroy();m("CONTENT_RESUME_REQUESTED");r=!1;n();a.aipComplete();aipAPItag.sendEvent("video-ad-removed")}function x(b){n();m(b.getError());p.contentComplete();f&&f.destroy();var c=(new Date).getTime()-A;1012==b.getError().getErrorCode()&&0<=c&&800>c?(m("AD BLOCKED",{timeElapsed:c}),a.aipConfig.AIP_BLOCKED&&a.aipConfig.AIP_BLOCKED(),aipAPItag.sendEvent("user-has-adblock")):
b.getError().getErrorCode()==google.ima.AdError.ErrorCode.VAST_EMPTY_RESPONSE||901==b.getError().getErrorCode()&&b.getError().getInnerError()&&"Error: No ads available"==b.getError().getInnerError().message?(m("NO ADS",{errorCode:b.getError().getErrorCode(),message:b.getError().getMessage(),innerError:b.getError().getInnerError(),vastErrorCode:b.getError().getVastErrorCode(),timeElapsed:c}),a.aipConfig.AIP_NOADS&&a.aipConfig.AIP_NOADS(),aipAPItag.sendEvent("video-ad-empty")):(m("ERROR",{errorCode:b.getError().getErrorCode(),
message:b.getError().getMessage(),innerError:b.getError().getInnerError(),vastErrorCode:b.getError().getVastErrorCode(),timeElapsed:c}),a.aipConfig.AIP_NOADS&&a.aipConfig.AIP_NOADS(),aipAPItag.sendEvent("video-ad-error"));r=!1;n();a.aipComplete()}function q(){w=!0;r=!1;p.contentComplete();f&&f.destroy();m("TIMEOUT");n();a.aipComplete();aipAPItag.sendEvent("video-ad-timeout")}function n(){t&&(clearTimeout(t),t=null)}function v(){a.aipConfig.AD_FULLSCREEN?(windowWidth=window.innerWidth||document.documentElement.clientWidth||
document.body.clientWidth,windowHeight=window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight):(windowWidth=b.offsetWidth,windowHeight=b.offsetHeight);return{adWidth:windowWidth,adHeight:windowHeight}}var p,f,r,A,t,w,m=function(){};window.addEventListener("error",function(a){if(r)try{m("WINDOW_EXCEPTION",{name:"WindowErrorListener: "+a.error.toString(),message:a.error.toString(),stack:a.error.stack})}catch(z){}});(function(){var d=new google.ima.AdDisplayContainer(c);
d.initialize();p=new google.ima.AdsLoader(d);p.getSettings().setVpaidMode(google.ima.ImaSdkSettings.VpaidMode.INSECURE);p.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,function(c){function d(a){return function(){"COMPLETE"==a&&(aipAPItag.sendEvent("video-ad-completed"),aipAPItag.completedTimeoutPreroll=setTimeout(u,1500));"CLICK"==a&&aipAPItag.sendEvent("video-ad-clicked");"USER_CLOSE"==a&&aipAPItag.sendEvent("video-ad-close");"SKIPPED"==a&&aipAPItag.sendEvent("video-ad-skipped");
m(a)}}if(!w){var e=new google.ima.AdsRenderingSettings;e.loadVideoTimeout=12E3;f=c.getAdsManager(b,e);f.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,x);f.addEventListener(google.ima.AdEvent.Type.CONTENT_PAUSE_REQUESTED,B);f.addEventListener(google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED,u);f.addEventListener(google.ima.AdEvent.Type.STARTED,C);f.addEventListener(google.ima.AdEvent.Type.SKIPPED,d("SKIPPED"));f.addEventListener(google.ima.AdEvent.Type.CLICK,d("CLICK"));f.addEventListener(google.ima.AdEvent.Type.PAUSED,
g);f.addEventListener(google.ima.AdEvent.Type.RESUMED,h);f.addEventListener(google.ima.AdEvent.Type.FIRST_QUARTILE,d("FIRST_QUARTILE"));f.addEventListener(google.ima.AdEvent.Type.MIDPOINT,d("MIDPOINT"));f.addEventListener(google.ima.AdEvent.Type.THIRD_QUARTILE,d("THIRD_QUARTILE"));f.addEventListener(google.ima.AdEvent.Type.LOADED,d("LOADED"));f.addEventListener(google.ima.AdEvent.Type.COMPLETE,d("COMPLETE"));f.addEventListener(google.ima.AdEvent.Type.USER_CLOSE,d("USER_CLOSE"));try{var n=v();a.aipConfig.AD_FULLSCREEN?
f.init(window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth,window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight,google.ima.ViewMode.FULLSCREEN):f.init(n.adWidth,n.adHeight,google.ima.ViewMode.NORMAL);f.start()}catch(E){l(E)}}});p.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,x)})();window.addEventListener("resize",function(){if(f&&r){var b=v();a.aipConfig.AD_FULLSCREEN?f.resize(window.innerWidth||document.documentElement.clientWidth||
document.body.clientWidth,window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight,google.ima.ViewMode.FULLSCREEN):f.resize(b.adWidth,b.adHeight,google.ima.ViewMode.NORMAL)}});this.requestAds=function(a,b){m=b;A=(new Date).getTime();var c=new google.ima.AdsRequest;c.adTagUrl=a;var d=v();c.linearAdSlotWidth=d.adWidth;c.linearAdSlotHeight=d.adHeight;c.nonLinearAdSlotWidth=d.adWidth;c.nonLinearAdSlotHeight=d.adHeight;c.forceNonLinearFullSlot=!0;c.setAdWillAutoPlay(!1);c.setAdWillPlayMuted(!1);
p.requestAds(c);t=setTimeout(q,15E3);w=!1;r=!0}}aipAPItag=new aipAPI;aipAPItag.setCurrency();aipAPItag.detectBlockedAds();aipAPItag.initGDPR();